...
def main(**kwargs):
    ...
    ff = FFmpeg(inputs={"./static/"+VideoExtractor.latest_title+"."+VideoExtractor.latest_ext: None},
                outputs={"./static/"+VideoExtractor.latest_title+".mp3": "-vn -ar 44100 -ac 2 -ab 192000 -f mp3"})
    ff.cmd
    ff.run()
    print(VideoExtractor.latest_title+"."+VideoExtractor.latest_ext, " "+VideoExtractor.latest_url)
    file_name_ext=VideoExtractor.latest_title+"."+VideoExtractor.latest_ext
