...
class VideoExtractor():
    ...
    def update_lastest_url_title(self,ext):
        VideoExtractor.latest_title=self.title
        VideoExtractor.latest_url=self.url
        VideoExtractor.latest_ext=ext
    ...
    def download(self, **kwargs):
        if 'json_output' in kwargs and kwargs['json_output']:
            ...
            self.update_lastest_url_title(ext)
